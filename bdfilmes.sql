...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/09/2025 às 22:45
...
INSERT INTO `tbator` (`ator`, `codAtor`) VALUES
('Guilhermy Pimentel Batista', 4);
...
--
ALTER TABLE `tbgenerofilme`
  MODIFY `codGeneroFilme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
